    ...
    return (
        <>
            <div className='bg-background'>
                {loading ? <Loading /> :
                    <div
                        className='md:max-w-[1200px] sm:w-full max-w-[500px] mx-auto md:pt-16 pt-10'
                        data-aos="fade-up"
                        data-aos-once="true"
                    ...
                    >
                        ...
                        <div className='mx-2 mt-5 mb-2'>
                            <h2 className='sm:text-3xl text-2xl font-semibold sm:mb-1 text-primary'>{project_name}</h2>
                            <p className='font-medium sm:mb-0 mb-2 text-primary'>{title}</p>
                            <p className='font-medium sm:text-base text-sm text-primary'>
                                <span className='font-semibold text-primary'>Technologies:</span> {tech}
                            </p>
                        </div>
                        <div className='mx-2'>
                            <h2 className='sm:text-2xl text-xl font-medium mb-2 text-primary'>Features</h2>
                            <ul className='sm:ml-5 ml-3 text-primary'>
                                {
                        ...
                        <div className='pt-5 mx-2'>
                            <a href={live_site} target='_blank'>
                                <button
                                    className='text-primary sm:px-5 px-4 sm:py-[10px] py-[8px] border-[#54CA95] border-2 rounded-3xl hover:bg-[#54CA95] hover:text-[#fff] duration-300 mr-3 sm:mt-0'>
                                    Live Website
                                </button>
                            </a>
                            <a href={client_site} target='_blank'>
                                <button
                                    className='text-primary sm:px-5 px-4 sm:py-[10px] py-[8px] border-[#54CA95] border-2 rounded-3xl hover:bg-[#54CA95] hover:text-[#fff] duration-300 mr-3 mt-3'>
                                    Client Site code
                                </button>
                            </a>
                            <a href={server_site} target='_blank'>
                                <button
                                    className='text-primary sm:px-5 px-4 sm:py-[10px] py-[8px] border-[#54CA95] border-2 rounded-3xl hover:bg-[#54CA95] hover:text-[#fff] duration-300 mr-3 sm:mt-0 mt-3'>
                                    Server Site code
                                </button>
                            </a>
                        </div>
