        ...
        <div className='container mx-auto'>
            <div className='md:flex justify-center items-center xl:py-[90px] md:py-[70px] pt-5 xl:px-[150px]'>
                ...
                >
                    ...
                    <p className=' mb-[30px] text-primary'>I'm a web developer focusing on the Front-end Development, Javascript, and MERN stack but still exploring other technologies and frameworks that catch my interest. if you're looking for a developer to add to your team, I'd love to hear from you!</p>
                    <div>
                        <a href="https://drive.google.com/file/d/1QAThA2q_xMkwTFmO0d8fdwqVFjINnnjR/view?usp=sharing" target="_blank" rel="noopener noreferrer">
                            <button
                                className='text-primary sm:px-5 px-4 sm:py-[10px] py-[8px] border-[#54CA95] border-2 rounded-3xl hover:bg-[#54CA95] hover:text-[#fff] duration-300 mr-3'>
                                Download Resume
                            </button>
                        </a>
                        <Link to='/contact'>
                            <button className='text-primary sm:px-5 px-4 sm:py-[10px] py-[8px] border-[#d5d5d5] border-2 rounded-3xl hover:bg-[#d5d5d5] hover:text-[#333] duration-300'>Contact</button>
                        </Link>
                    </div>
                </div>
            </div>
